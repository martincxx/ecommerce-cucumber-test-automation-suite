...
class amazonApp extends Page {
  get search() {
    return $(
      "#root > div > main > div > ul.filter > li:nth-child(1) > form > input"
    );
  }
  get signIn() {
    return $("#root > div > header > div.header-links > a:nth-child(2)");
  }
  get createAccount() {
    return $(
      "#root > div > main > div > div > form > ul > li:nth-child(7) > a"
    );
  }
  get cart() {
    return $("#root > div > header > div.header-links > a:nth-child(1)");
  }

  get amazona() {
    return $("#root > div > header > div.brand > a");
  }
  get logOut() {
    return $(
      "#root > div > main > div > div > div.profile-info > div > form > ul > li:nth-child(7) > button"
    );
  }
  ...
  get productQuantity() {
    return $(
      "#root > div > main > div > div > div.details > div.details-action > ul > li:nth-child(3) > select"
    );
  }
  get addToCartButton() {
    return $(
      "#root > div > main > div > div > div.details > div.details-action > ul > li:nth-child(4) > button"
    );
  }
